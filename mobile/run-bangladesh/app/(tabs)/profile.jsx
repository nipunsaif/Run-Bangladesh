...
export default function Profile() {
  ...
  const fetchData = async () => {
    try {
      ...
      if (!response.ok) throw new Error(data.message || "Failed to fetch user events");
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.booksHeader}>
        <Text style={styles.booksTitle}>Your Events</Text>
        <Text style={styles.booksCount}>{books.length} events</Text>
      </View>
